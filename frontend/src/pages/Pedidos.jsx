...
function Pedidos() {
  ...
  // Lógica extraída a src/lib/progresoPedido.js (CONTRATO_HARDENING_A1_A4.md, A2) para poder cubrirla
  // con tests de regresión sin montar este componente -- ver ese archivo para el porqué del atajo en
  // pedidos 'servido'.
  function calcularProgresoPedido(p) {
    return calcularProgresoPedidoBase(p, stockPorProduccionId, sumaPrevistoPorProduccionId)
  }
