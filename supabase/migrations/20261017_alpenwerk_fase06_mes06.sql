...
select v_p_mtl007, entrada_material_id, 20*0.45, v_neg from stock_lotes_articulo where articulo_id=v_art_mtl007 and stock_disponible>=20*0.45 order by fecha_recepcion limit 1;
